...
class ModeloClientes{
    ...
    static public function mdlIngresarCliente($tabla, $datos){
        ...
        $stmt->bindParam(":documento", $datos["documento"], PDO::PARAM_STR); // Corregido: PDO::PARAM_STR
    ...
    static public function mdlEditarCliente($tabla, $datos){
        ...
        $stmt->bindParam(":id", $datos["id"], PDO::PARAM_INT); // Estaba bien, ID es un entero
        $stmt->bindParam(":nombre", $datos["nombre"], PDO::PARAM_STR);
        $stmt->bindParam(":documento", $datos["documento"], PDO::PARAM_STR); // Corregido: PDO::PARAM_STR
        $stmt->bindParam(":email", $datos["email"], PDO::PARAM_STR);
        $stmt->bindParam(":telefono", $datos["telefono"], PDO::PARAM_STR);
    ...
    static public function mdlEliminarCliente($tabla, $datos){
        ...
        $stmt -> bindParam(":id", $datos, PDO::PARAM_INT); // Estaba bien, ID es un entero
